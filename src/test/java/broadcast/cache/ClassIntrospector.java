...
//        res = ci.introspect( MyGoofyClass.class);
//        unsafe.putObject(MyGoofyClass.class, 0L, MyGoofyClassSub.class);
//new MyGoofyClass().print();
        
        
        long baseOffset = unsafe.arrayBaseOffset(MyGoofyClass.class);
